...
- (void)viewDidLoad {
    ...
    self.viewContainer = [[UIView alloc]initWithFrame:CGRectMake(0, 64, SCREEN_WIDTH, SCREEN_HEIGHT- 64)];
    [self.view addSubview:self.viewContainer];
    self.takeButton = [[UIButton alloc]initWithFrame:CGRectMake(0, SCREEN_HEIGHT-64, SCREEN_WIDTH, 64)];
    [self.takeButton setBackgroundColor:[UIColor blueColor]];
